        ...
        <section id="portfolio" class="py-20 md:py-32"><div class="max-w-6xl mx-auto"><h2 class="text-4xl md:text-5xl font-bold text-center mb-12 scroll-animate">Portofolio Pilihan</h2><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
         ...
         <div class="text-center mt-16 scroll-animate delay-4">
            <a href="{{ route('portofolio') }}" 
               class="inline-block bg-yellow-400 text-gray-900 font-bold py-3 px-8 rounded-lg transition-transform duration-300 hover:bg-yellow-500 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 focus:ring-offset-gray-900">
                Lihat Semua Proyek
            </a>
        </div>
    </div>
